...
// ===================================================================================
// CATATAN UNTUK ANDA:
// Ganti URL gambar placeholder di bawah ini dengan URL aset Anda sendiri.
// Saya menggunakan gambar dari Pexels dan Picsum Photos sebagai contoh.
// ===================================================================================
  ...
  id: {
    ...
    hero: {
      seo: {
        ...
        description:
          "Temukan esensi kekayaan Nusantara. KAMI SPICES menghadirkan rempah-rempah premium Indonesia berkualitas ekspor ke panggung dunia. Jelajahi produk kami.",
      },
      title: "Esensi Kekayaan Nusantara",
      subtitle:
        "Menghadirkan rempah-rempah premium Indonesia ke panggung dunia.",
    ...
    productsPage: {
      seo: {
        ...
        description:
          "Jelajahi katalog lengkap rempah-rempah premium kami, dari cengkeh Maluku hingga lada Muntok. Kualitas terbaik untuk kebutuhan kuliner dan industri Anda.",
      },
      title: "Katalog Produk Premium",
      description:
        "Temukan rempah-rempah terbaik dari kepulauan Indonesia, dipilih dengan cermat untuk kualitas dan rasa yang tak tertandingi.",
    ...
    blogPage: {
      seo: {
        ...
        description:
          "Baca artikel terbaru, resep, dan wawasan mendalam dari dunia rempah-rempah Indonesia. Jelajahi cerita di balik setiap aroma dan rasa.",
      },
      title: "Wawasan dari Dunia Rempah",
      description:
        "Jelajahi cerita, resep, dan tradisi di balik rempah-rempah kami yang berharga.",
    ...
    aboutPage: {
      seo: {
        ...
        description:
          "Kenali cerita di balik KAMI SPICES. Visi kami adalah menjadi tolok ukur kualitas rempah mewah Indonesia, menjalin kemitraan yang adil dengan petani lokal.",
      },
      section1: {
        ...
        listItem1:
          "Integritas dalam Setiap Butir: Dari benih hingga tiba di tangan Anda, setiap proses kami lalui dengan standar tertinggi, memastikan kemurnian yang tak tertandingi.",
        listItem2:
          "Kualitas Tanpa Kompromi: Kami mendedikasikan diri untuk memilih hanya hasil panen terbaik, yang diproses dengan metode warisan untuk mengunci kekayaan rasa dan aroma.",
        listItem3:
      ...
      section2: {
        ...
        visionText:
          "Menjadi tolok ukur kemewahan dan kualitas rempah di Indonesia, serta melestarikan dan mengangkat warisan cita rasa Nusantara ke panggung dunia dan menginspirasi dunia kuliner dengan warisan terbaik dari tanah air.",
        missionTitle: "Misi Kami",
        missions: [
          {
            icon: "award",
            title: "Menghadirkan Kualitas Terbaik",
            text: "Secara konsisten menyeleksi dan mempersembahkan hanya rempah-rempah dengan kualitas tertinggi dari sumber terbaik di seluruh kepulauan Indonesia.",
          },
          {
            icon: "seedling",
            title: "Menjaga Kemurnian dan Tradisi",
            text: "Menggabungkan kearifan metode pengolahan tradisional dengan standar modern yang ketat untuk mengunci kemurnian aroma dan cita rasa autentik.",
          },
          {
            icon: "handshake",
            title: "Membangun Kemitraan Berintegritas",
            text: "Menjalin hubungan yang adil, berkelanjutan, dan saling menghormati dengan para petani lokal sebagai mitra utama kami.",
          },
          {
            icon: "star",
            title: "Memberikan Pengalaman Eksklusif",
            text: "Menciptakan pengalaman yang tak terlupakan bagi setiap pelanggan, dari kemasan yang mewah hingga pelayanan yang personal.",
          },
        ],
      },
      section3: {
        ...
        subtitle:
          "Kami percaya kualitas terbaik lahir dari ketulusan dan dedikasi dalam setiap proses.",
        pillars: [
          {
            icon: "gem",
            title: "Kualitas Premium",
            text: "Kami hanya memilih bahan terbaik yang diproses dengan standar tinggi untuk menjaga rasa dan aroma alami.",
          },
          {
            icon: "globe",
            title: "Asli dari Indonesia",
            text: "Sumber kami berasal langsung dari petani lokal di berbagai daerah nusantara, mendukung produk lokal dan keberlanjutan.",
          },
          {
            icon: "shield-check",
            title: "Bersertifikat & Terjamin",
            text: "Produk kami telah melalui uji mutu dan memiliki sertifikasi halal serta standar internasional.",
          },
          {
            icon: "truck",
            title: "Pengiriman Cepat & Aman",
            text: "Didukung sistem distribusi efisien dan kemasan modern agar produk tiba dengan kualitas sempurna ke seluruh dunia.",
          },
        ],
      },
      section4: {
        ...
        testimonials: [
          {
            name: "Andrian Ishak",
            position: "Executive Chef, Namaaz Dining",
            quote:
              "Kualitas rempah dari KAMI SPICES tak tertandingi. Konsistensi aroma dan rasanya mengangkat setiap hidangan yang kami sajikan ke level berikutnya. Mereka adalah mitra yang sangat kami andalkan.",
            image:
              "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Isabelle Dubois",
            position: "Purchasing Manager, European Gourmet Foods",
            quote:
              "Sebagai importir, kami membutuhkan keandalan dan kualitas premium. KAMI SPICES tidak pernah mengecewakan. Proses sertifikasi dan pengiriman mereka sangat profesional.",
            image:
              "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Kenji Tanaka",
            position: "Founder, Spice Artisan Tokyo",
            quote:
              "Saya telah mencari pala dan cengkeh kualitas terbaik dari Indonesia selama bertahun-tahun. Pencarian saya berakhir di KAMI SPICES. Produk mereka benar-benar autentik.",
            image:
        ...
        team: [
          {
            name: "Arya Wijaya",
            role: "Founder & CEO",
            bio: "Dengan hasrat mendalam terhadap warisan agraris Indonesia, Arya mendirikan KAMI SPICES untuk berbagi kekayaan rempah nusantara dengan dunia.",
            image:
              "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Siti Rahayu",
            role: "Head of Sourcing & Quality",
            bio: "Seorang ahli botani, Siti memastikan setiap rempah yang kami peroleh memenuhi standar kemurnian, aroma, dan rasa yang ketat.",
            image:
              "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Budi Santoso",
            role: "Director of Global Partnerships",
            bio: "Budi menjembatani hubungan antara kekayaan alam Indonesia dan pasar global, memastikan kemitraan yang adil dan distribusi yang efisien.",
            image:
              "https://images.unsplash.com/photo-1537511446984-935f663eb1f4?auto=format&fit=crop&w=500&q=60",
          },
        ],
      },
    },
    contactPage: {
      seo: {
        ...
        description:
          "Hubungi tim ahli kami untuk informasi produk, pemesanan B2B, atau kemitraan. Kami siap membantu Anda memulai perjalanan rasa bersama KAMI SPICES.",
      },
      title: "Hubungi Tim Ahli Kami",
      intro:
        "Di KAMI SPICES, setiap pertanyaan adalah awal dari sebuah kemitraan yang berharga. Tim kami yang berdedikasi siap memberikan informasi mendalam, solusi yang disesuaikan, dan layanan yang melampaui ekspektasi. Hubungi kami untuk memulai perjalanan rasa Anda.",
      contactInfo: [
        {
          icon: "map-pin",
          title: "Alamat Kantor",
          text: "Menara Cakrawala, Lt.10\nJl. M.H. Thamrin No.9\nJakarta 10340, Indonesia",
          link: "https://www.google.com/maps/search/?api=1&query=Menara+Cakrawala,+Jl.+MH.+Thamrin+No.9",
        },
        {
          icon: "mail",
          title: "Alamat Email",
          text: "info@kamispices.co.id",
          subtext: "Kami merespon dalam 24 jam",
          link: "mailto:info@kamispices.co.id?subject=Permintaan Informasi Produk dari Website KAMI SPICES",
        },
        {
          icon: "phone",
          title: "Telepon / WhatsApp",
          text: "+62 812 8629 6432",
          subtext: "Hubungi untuk respons cepat",
          link: "https://api.whatsapp.com/send?phone=6281286296432&text=Halo%20KAMI%20SPICES",
        },
        {
          icon: "clock",
          title: "Jam Operasional",
          text: "Senin – Jumat: 08.00 – 17.00\nSabtu: 08.00 – 12.00",
          subtext: "Minggu: Tutup",
          link: "#",
        },
      ],
      ...
      socialMediaLinks: [
        {
          platform: "instagram",
          url: "https://instagram.com/kamispices.indonesia",
        },
        { platform: "tiktok", url: "https://tiktok.com/@kamispices.indonesia" },
        { platform: "twitter", url: "https://x.com/kamispices.indonesia" },
        {
          platform: "facebook",
          url: "https://facebook.com/kamispices.indonesia",
        },
      ],
      faqTitle: "Pertanyaan yang Sering Diajukan",
      faqs: [
        {
          question: "Apa yang membedakan KAMI SPICES dari pemasok lain?",
          answer:
            "Kualitas tanpa kompromi. Kami tidak hanya menjual rempah, kami mengkurasi pengalaman. Setiap produk melalui proses seleksi ketat oleh ahli kami, dari pemilihan lahan tanam hingga metode pengolahan yang menjaga keaslian rasa dan aroma.",
        },
        {
          question: "Bagaimana cara memesan dalam jumlah besar (B2B)?",
          answer:
            "Silakan hubungi kami melalui email di info@kamispices.co.id atau WhatsApp. Tim kemitraan global kami akan segera membantu Anda dengan katalog B2B, harga khusus, dan opsi pengiriman internasional.",
        },
        {
          question: "Apakah produk KAMI SPICES memiliki sertifikasi?",
          answer:
            "Tentu. Semua produk kami memiliki sertifikasi Halal dan telah melewati standar keamanan pangan internasional. Kami dapat menyediakan dokumen sertifikasi yang relevan sesuai permintaan Anda.",
        },
        {
          question: "Apakah saya bisa meminta sampel produk?",
          answer:
            "Ya, kami menyediakan sampel untuk klien B2B potensial. Hubungi tim kami untuk mendiskusikan kebutuhan Anda, dan kami akan mengatur pengiriman sampel produk yang Anda minati.",
        },
        {
          question: "Dari mana asal rempah-rempah KAMI SPICES?",
          answer:
            "Kami bekerja sama langsung dengan petani dan komunitas di daerah-daerah yang terkenal sebagai penghasil rempah terbaik di Indonesia, seperti Maluku untuk cengkeh dan pala, Sumatera untuk kayu manis, dan Bangka untuk lada putih. Kami percaya pada keterlacakan penuh dan transparansi sumber.",
        },
        {
          question: "Apakah KAMI SPICES melayani pengiriman internasional?",
          answer:
            "Ya, kami berspesialisasi dalam logistik global untuk klien B2B kami. Tim kami menangani semua dokumentasi ekspor yang diperlukan dan bekerja sama dengan mitra pengiriman terpercaya untuk memastikan pesanan Anda tiba dengan aman dan tepat waktu, di mana pun di dunia.",
        },
        {
          question: "Apakah semua produk Anda organik?",
          answer:
            "Kami memprioritaskan praktik pertanian yang berkelanjutan dan alami. Meskipun beberapa produk kami, seperti Kunyit, bersertifikat organik, produk lainnya berasal dari petani kecil tradisional yang mungkin tidak memiliki sertifikasi resmi tetapi tetap mematuhi metode berkualitas tinggi dan bebas pestisida. Silakan periksa detail produk untuk sertifikasi spesifik.",
        },
      ],
    },
    footer: {
    ...
    products: [
      {
        ...
        details: [
          ...
          "Tingkat Kualitas: Grade A",
          "Aroma: Kuat, manis, pedas",
      ...
      },
      {
        ...
        details: [
          ...
          "Tingkat Kualitas: Grade AA",
          "Aroma: Manis, hangat, kayu",
          "Penggunaan: Kue, kopi, kari",
        ],
      },
      {
        id: 3,
        ...
        details: [
          ...
          "Tingkat Kualitas: Grade S",
          "Aroma: Pedas, musky, manis",
          "Penggunaan: Saus, sup, hidangan daging",
        ],
      },
      {
        id: 4,
        ...
        details: [
          ...
          "Tingkat Kualitas: Muntok White Pepper",
          "Aroma: Tajam, bersahaja",
          "Penggunaan: Hidangan Eropa & Asia, saus krim",
        ],
      },
      {
        id: 5,
        ...
        details: [
          ...
          "Tingkat Kualitas: Grade A Super",
          "Aroma: Pedas, tajam, sedikit fruity",
          "Penggunaan: Bumbu steak, sup, hidangan panggang",
        ],
      },
      {
        id: 6,
        ...
        details: [
          ...
          "Tingkat Kualitas: Organik",
          "Aroma: Bersahaja, sedikit pahit",
          "Penggunaan: Kari, jamu, pewarna alami",
        ],
      },
      {
        id: 7,
        ...
        details: [
          ...
          "Tingkat Kualitas: Grade 1",
          "Aroma: Segar, pedas, sitrus",
          "Penggunaan: Minuman hangat, bumbu tumis, kue",
        ],
      },
      {
        id: 8,
  ...
  en: {
    ...
    hero: {
      seo: {
        ...
        description:
          "Discover the essence of the archipelago. KAMI SPICES brings premium, export-quality Indonesian spices to the world stage. Explore our products.",
      },
      title: "The Essence of the Archipelago",
      subtitle: "Bringing premium Indonesian spices to the world stage.",
      tagline: "A legacy of aromatic spices, a luxury of taste.",
    ...
    productsPage: {
      seo: {
        ...
        description:
          "Explore our complete catalog of premium spices, from Maluku cloves to Muntok white pepper. The finest quality for your culinary and industrial needs.",
      },
      title: "Premium Product Catalog",
      description:
        "Discover the finest spices from the Indonesian archipelago, meticulously selected for unparalleled quality and flavor.",
    ...
    blogPage: {
      seo: {
        ...
        description:
          "Read the latest articles, recipes, and in-depth insights from the world of Indonesian spices. Explore the stories behind every aroma and flavor.",
      },
      title: "Insights from the Spice World",
      description:
        "Explore the stories, recipes, and traditions behind our prized spices.",
    ...
    aboutPage: {
      seo: {
        ...
        description:
          "Learn the story behind KAMI SPICES. Our vision is to be the benchmark for luxury Indonesian spices, fostering fair partnerships with local farmers.",
      },
      section1: {
        title: "A Curated Spice Atelier",
        ...
        listItem1:
          "Integrity in Every Grain: From the seed to your hands, every process we undertake meets the highest standards, ensuring unparalleled purity.",
        listItem2:
      ...
      section2: {
        ...
        visionText:
          "To be the benchmark of luxury and quality for spices in Indonesia, preserving and elevating the archipelago's flavor heritage to the world stage and inspiring the culinary world with the best from our homeland.",
        missionTitle: "Our Mission",
        missions: [
          {
            icon: "award",
            title: "Presenting the Finest Quality",
            text: "Consistently selecting and presenting only the highest quality spices from the best sources throughout the Indonesian archipelago.",
          },
          {
            icon: "seedling",
            title: "Preserving Purity and Tradition",
            text: "Combining the wisdom of traditional processing methods with strict modern standards to lock in the authentic purity of aroma and flavor.",
          },
          {
            icon: "handshake",
            title: "Building Partnerships with Integrity",
            text: "Fostering fair, sustainable, and respectful relationships with local farmers as our key partners.",
          },
          {
            icon: "star",
            title: "Delivering an Exclusive Experience",
            text: "Creating an unforgettable experience for every customer, from luxurious packaging to personalized service.",
          },
        ],
      },
      section3: {
        title: "Why Choose Us?",
        subtitle:
          "We believe the best quality is born from sincerity and dedication in every process.",
        pillars: [
          {
            icon: "gem",
            title: "Premium Quality",
            text: "We select only the best ingredients processed to high standards to preserve natural taste and aroma.",
          },
          {
            icon: "globe",
            title: "Authentically Indonesian",
            text: "Our sources come directly from local farmers in various regions of the archipelago, supporting local products and sustainability.",
          },
          {
            icon: "shield-check",
            title: "Certified & Guaranteed",
            text: "Our products have undergone quality testing and have halal certification as well as international standards.",
          },
          {
            icon: "truck",
            title: "Fast & Secure Shipping",
            text: "Supported by an efficient distribution system and modern packaging to ensure products arrive in perfect quality worldwide.",
          },
        ],
      },
      section4: {
        ...
        testimonials: [
          {
            ...
            position: "Executive Chef, Namaaz Dining",
            quote:
              "The quality of spices from KAMI SPICES is unparalleled. The consistency of their aroma and flavor elevates every dish we serve to the next level. They are a partner we deeply rely on.",
            image:
              "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&w=500&q=60",
          },
          {
            ...
            position: "Purchasing Manager, European Gourmet Foods",
            quote:
              "As importers, we require reliability and premium quality. KAMI SPICES has never disappointed. Their certification and shipping processes are exceptionally professional.",
            image:
              "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=500&q=60",
          },
          {
            ...
            position: "Founder, Spice Artisan Tokyo",
            quote:
              "I searched for the best quality Indonesian nutmeg and cloves for years. My search ended with KAMI SPICES. Their products are truly authentic.",
            image:
              "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=500&q=60",
          },
        ],
        ...
        team: [
          {
            name: "Arya Wijaya",
            role: "Founder & CEO",
            bio: "With a deep passion for Indonesia's agricultural heritage, Arya founded KAMI SPICES to share the archipelago's spice wealth with the world.",
            image:
              "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Siti Rahayu",
            role: "Head of Sourcing & Quality",
            bio: "A botanist with decades of experience, Siti ensures every spice we procure meets our rigorous standards for purity, aroma, and flavor.",
            image:
              "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=500&q=60",
          },
          {
            name: "Budi Santoso",
            role: "Director of Global Partnerships",
            bio: "Budi bridges the gap between Indonesia's natural treasures and the global market, ensuring fair partnerships and efficient distribution.",
            image:
              "https://images.unsplash.com/photo-1537511446984-935f663eb1f4?auto=format&fit=crop&w=500&q=60",
          },
        ],
    ...
    contactPage: {
      seo: {
        ...
        description:
          "Contact our expert team for product information, B2B orders, or partnerships. We are ready to help you start your flavor journey with KAMI SPICES.",
      },
      title: "Contact Our Expert Team",
      intro:
        "At KAMI SPICES, every inquiry is the beginning of a valuable partnership. Our dedicated team is ready to provide in-depth information, tailored solutions, and service that exceeds expectations. Contact us to begin your flavor journey.",
      contactInfo: [
        {
          icon: "map-pin",
          title: "Office Address",
          text: "Menara Cakrawala, 10th Floor\nJl. M.H. Thamrin No.9\nJakarta 10340, Indonesia",
          link: "https://www.google.com/maps/search/?api=1&query=Menara+Cakrawala,+Jl.+MH.+Thamrin+No.9",
        },
        {
          icon: "mail",
          ...
          link: "mailto:info@kamispices.co.id?subject=Product Inquiry from KAMI SPICES Website",
        },
        {
          icon: "phone",
          title: "Phone / WhatsApp",
          text: "+62 812 8629 6432",
          subtext: "Call for a quick response",
          link: "https://api.whatsapp.com/send?phone=6281286296432&text=Hello%20KAMI%20SPICES",
        },
        {
          icon: "clock",
          title: "Operating Hours",
          text: "Monday - Friday: 08:00 - 17:00\nSaturday: 08:00 - 12:00",
      ...
      faqs: [
        {
          question: "What distinguishes KAMI SPICES from other suppliers?",
          answer:
            "Uncompromising quality. We don't just sell spices; we curate experiences. Every product undergoes a rigorous selection process by our experts, from choosing the farmland to processing methods that preserve authentic flavor and aroma.",
        },
        {
          question: "How can I place a bulk (B2B) order?",
          answer:
            "Please contact us via email at info@kamispices.co.id or on WhatsApp. Our global partnerships team will promptly assist you with our B2B catalog, special pricing, and international shipping options.",
        },
        {
          question: "Are KAMI SPICES products certified?",
          answer:
            "Absolutely. All our products are Halal certified and have passed international food safety standards. We can provide relevant certification documents upon your request.",
        },
        {
          question: "Can I request product samples?",
          answer:
            "Yes, we provide samples for potential B2B clients. Contact our team to discuss your needs, and we will arrange for the shipment of samples of the products you are interested in.",
        },
        {
          question: "Where do KAMI SPICES' spices originate from?",
          answer:
            "We partner directly with farmers and communities in the most renowned spice-producing regions of Indonesia, such as Maluku for cloves and nutmeg, Sumatra for cinnamon, and Bangka for white pepper. We believe in full traceability and source transparency.",
        },
        {
          question: "Do you offer international shipping?",
          answer:
            "Yes, we specialize in global logistics for our B2B clients. Our team handles all necessary export documentation and works with trusted freight partners to ensure your order arrives safely and on time, anywhere in the world.",
        },
        {
          question: "Are all of your products organic?",
          answer:
            "We prioritize sustainable and natural farming practices. While several of our products, like our Turmeric, are certified organic, others are sourced from traditional smallholder farms that may not have official certification but still adhere to high-quality, pesticide-free methods. Please check the product details for specific certifications.",
        },
      ],
    },
    footer: {
    ...
    products: [
      {
        ...
        details: [
          ...
          "Aroma: Strong, sweet, pungent",
          "Uses: Cuisine, beverages, traditional medicine",
        ],
      },
      {
        id: 2,
        ...
        details: [
          ...
          "Quality Grade: Grade AA",
          "Aroma: Sweet, warm, woody",
          "Uses: Pastries, coffee, curries",
        ],
      },
      {
        id: 3,
        ...
        details: [
          ...
          "Quality Grade: Grade S",
          "Aroma: Pungent, musky, sweet",
          "Uses: Sauces, soups, meat dishes",
        ],
      },
      {
        id: 4,
        ...
        details: [
          ...
          "Quality Grade: Muntok White Pepper",
          "Aroma: Sharp, earthy",
          "Uses: European & Asian cuisine, cream sauces",
        ],
      },
      {
        id: 5,
        ...
        details: [
          ...
          "Quality Grade: Grade A Super",
          "Aroma: Pungent, sharp, slightly fruity",
          "Uses: Steak seasoning, soups, roasted dishes",
        ],
      },
      {
        id: 6,
        ...
        details: [
          ...
          "Quality Grade: Organic",
          "Aroma: Earthy, slightly bitter",
          "Uses: Curries, traditional tonics, natural food coloring",
        ],
      },
      {
        id: 7,
      ...
      },
      {
        ...
        details: [
          ...
          "Uses: Arabic coffee, biryani, desserts",
        ],
      },
    ],
    blogPosts: [
      ...
      },
      {
        id: 8,
        title:
          "Tracing the Vanilla Trail: The Aromatic Orchid of the Archipelago",
        author: "Arya Wijaya",
